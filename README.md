...
## Inhalt / Contents
- in/ - Binärdateien / Binary files
- cheats/ - Cheat-Codes / Cheat codes
- config/ - Konfigurationsdateien / Configuration files
- lib/ - Bibliotheken / Libraries
- launch.sh - Start-Skript / Launch script

## Lizenz / License
Siehe LICENSE-Datei / See LICENSE file

---

**Erstellt mit KI-Unterstützung / Created with AI assistance**